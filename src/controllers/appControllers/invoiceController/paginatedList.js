...
const paginatedList = async (req, res) => {
  ...
  try {
    ...
    if (req.admin && (req.admin.role === 'admin' || req.admin.role === 'superadmin')) {
      // Si c'est un administrateur ou un super administrateur, récupérer toutes les factures sans filtre par utilisateur
      ...
      // Renvoyer la réponse avec toutes les factures
      if (count > 0) {
